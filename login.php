...
if (isset($_POST['btn-login'])) {
    ...
    // Menyimpan jumlah percobaan kegagalan login dalam variabel sesi
    ...
    if ($cekadmin > 0) {
        ...
        $_SESSION['login_attempts']++; // Menambahkan jumlah percobaan kegagalan login

        if ($_SESSION['login_attempts'] >= 3) {
            // Menutup aplikasi setelah tiga kali kesalahan password
            echo "<script>alert('Anda telah mencoba login lebih dari 3 kali. Aplikasi akan ditutup.'); window.close();</script>";
            exit();
        }
...
.btn{
  ...
  <div align="center">
   ...
   <img class="masthead-avatar mb-5" src="assets/img/avataaars.svg" width="10%" alt="">
