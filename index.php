    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">SMA Negeri 4 Kota Malang</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="panduan">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis corporis vero id nam quasi, libero, fugit, qui quam sed sequi delectus expedita rerum magnam saepe ut ipsum similique ipsam. Eius?</p></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, veniam, nisi odio voluptatum excepturi magni quod dicta.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>PPDB Online</small></div>
        </div>
